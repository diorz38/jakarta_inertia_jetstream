                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <jet-nav-link :href="route('dashboard')" :active="route().current('dashboard')"> <i class="bx bx-home mr-1"></i>Dashboard </jet-nav-link>
                            </div>
                            <div x-data="{ open: false }" x-on:click.outside="open = false" class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <button x-on:click="open = !open" :active="route().current('projects*')" class="inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium leading-5">
                                    <span>
                                        <i class="bx bxs-book-content mr-1"></i>Kegiatan
                                ...
                                <div x-show="open"
                                    ...
                                    class="absolute mt-12 origin-botom-left rounded-md shadow-lg md:w-48">
                                    <div class="px-2 py-2 bg-white shadow dark-mode:bg-gray-800">
                                        <jet-dropdown-link :href="route('projects.index')" class="active:text-indigo-600" :active="route().current('projects.index')">
                                            Kegiatan Tahun Ini
                                        </jet-dropdown-link>
                                        <jet-dropdown-link href="#" class="text-indigo-600"> Sub Kegiatan </jet-dropdown-link>
                                        <jet-dropdown-link href="#"> Daftar Skor </jet-dropdown-link>
                                    </div>
                                </div>
                            </div>
                        </div>
